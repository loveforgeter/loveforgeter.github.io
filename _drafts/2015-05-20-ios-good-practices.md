...
翻译自[iOS Good Practices](https://github.com/futurice/ios-good-practices)
...
### 结构 <span class="over-show">[structure](https://github.com/futurice/ios-good-practices#structure)</span>

用[Pragma marks](http://nshipster.com/pragma/)可以很好的对方法进行分类，特别是在view controller中。 下面的例子几乎对所有的view controller都适用：
...
#pragma mark - Lifecycle 对象生命周期

- (instancetype)initWithFoo:(Foo *)foo;
- (void)dealloc;

#pragma mark - View Lifecycle 视图生命周期
...
#pragma mark - XYZFoobarDelegate 委托方法

- (void)foobar:(Foobar *)foobar didSomethingWithFoo:(Foo *)foo;

#pragma mark - Internal Helpers 辅助方法
